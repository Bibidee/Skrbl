"""
Phase 3D – Script 1
Creates apps/web/components/scrabble/WinnerModal.tsx

Auto-shows when game.status === 'completed'. Displays winner + all scores.
"""
import pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
TARGET = ROOT / "apps" / "web" / "components" / "scrabble" / "WinnerModal.tsx"
