"""
Phase 3E – Script 1
Creates apps/web/app/api/games/[gameId]/chat/route.ts

GET  – fetch last 100 messages for a game (by genlayer_game_id or UUID)
POST – send a message (SIWE auth required)
"""
import pathlib

ROOT = pathlib.Path(__file__).resolve().parent.parent
TARGET = ROOT / "apps" / "web" / "app" / "api" / "games" / "[gameId]" / "chat" / "route.ts"
